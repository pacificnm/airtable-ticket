...
import { TicketDetailsTab } from '../pages/tabs/TicketDetailsTab';
import { TicketNotesTab } from '../pages/tabs/TicketNotesTab';
import { TicketDevicesTab } from '../pages/tabs/TicketDevicesTab';
import { TicketSoftwareTab } from '../pages/tabs/TicketSoftwareTab';
import { TicketDocumentsTab } from '../pages/tabs/TicketDocumentsTab';
import { TicketHistoryTab } from '../pages/tabs/TicketHistoryTab';
import { TicketTasksTab } from '../pages/tabs/TicketTasksTab';
import { TicketDashboardsTab } from '../pages/tabs/TicketDashboardsTab';
